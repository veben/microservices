...
public interface JpaDeveloperInformationRepository extends
    ...
    @Override
    default Optional<DeveloperInformation> findInformationsFromDeveloperId(String developerId) {
        return Optional.ofNullable(findDeveloperInformationByDeveloperId(developerId));
    }
